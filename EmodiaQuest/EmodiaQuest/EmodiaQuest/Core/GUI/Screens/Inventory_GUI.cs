...
namespace EmodiaQuest.Core.GUI.Screens
{
    public class Inventory_GUI
    {
        ...
        void ButtonEventValue(object source, ButtonEvent_GUI e)
        {
            ...
            {
                case "itemSlot1":
                    platform.updateLabel("item_name", Player.Instance.PlayerInventory.Count >= 1 && Player.Instance.PlayerInventory[0] != null ? Player.Instance.PlayerInventory[0].Name : "");
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 1 && Player.Instance.PlayerInventory[0] != null ? "Level: " + Player.Instance.PlayerInventory[0].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[0].RequiredStrength : "");
                ...
                case "itemSlot2":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 2 && Player.Instance.PlayerInventory[1] != null ? "Level: " + Player.Instance.PlayerInventory[1].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[1].RequiredStrength : "");
                ...
                case "itemSlot3":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 3 && Player.Instance.PlayerInventory[2] != null ? "Level: " + Player.Instance.PlayerInventory[2].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[2].RequiredStrength : "");
                ...
                case "itemSlot4":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 4 && Player.Instance.PlayerInventory[3] != null ? "Level: " + Player.Instance.PlayerInventory[3].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[3].RequiredStrength : "");
                ...
                case "itemSlot5":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 5 && Player.Instance.PlayerInventory[4] != null ? "Level: " + Player.Instance.PlayerInventory[4].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[4].RequiredStrength : "");
                ...
                case "itemSlot6":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 6 && Player.Instance.PlayerInventory[5] != null ? "Level: " + Player.Instance.PlayerInventory[5].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[5].RequiredStrength : "");
                ...
                case "itemSlot7":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 7 && Player.Instance.PlayerInventory[6] != null ? "Level: " + Player.Instance.PlayerInventory[6].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[6].RequiredStrength : "");
                ...
                case "itemSlot8":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 8 && Player.Instance.PlayerInventory[7] != null ? "Level: " + Player.Instance.PlayerInventory[7].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[7].RequiredStrength : "");
                ...
                case "itemSlot9":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 9 && Player.Instance.PlayerInventory[8] != null ? "Level: " + Player.Instance.PlayerInventory[8].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[8].RequiredStrength : "");
                ...
                case "itemSlot10":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 10 && Player.Instance.PlayerInventory[9] != null ? "Level: " + Player.Instance.PlayerInventory[9].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[9].RequiredStrength : "");
                ...
                case "itemSlot11":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 11 && Player.Instance.PlayerInventory[10] != null ? "Level: " + Player.Instance.PlayerInventory[10].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[10].RequiredStrength : "");
                ...
                case "itemSlot12":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 12 && Player.Instance.PlayerInventory[11] != null ? "Level: " + Player.Instance.PlayerInventory[11].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[11].RequiredStrength : "");
                ...
                case "itemSlot13":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 13 && Player.Instance.PlayerInventory[12] != null ? "Level: " + Player.Instance.PlayerInventory[12].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[12].RequiredStrength : "");
                ...
                case "itemSlot14":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 14 && Player.Instance.PlayerInventory[13] != null ? "Level: " + Player.Instance.PlayerInventory[13].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[13].RequiredStrength : "");
                ...
                case "itemSlot15":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 15 && Player.Instance.PlayerInventory[14] != null ? "Level: " + Player.Instance.PlayerInventory[14].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[14].RequiredStrength : "");
                ...
                case "itemSlot16":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 16 && Player.Instance.PlayerInventory[15] != null ? "Level: " + Player.Instance.PlayerInventory[15].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[15].RequiredStrength : "");
                ...
                case "itemSlot17":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 17 && Player.Instance.PlayerInventory[16] != null ? "Level: " + Player.Instance.PlayerInventory[16].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[16].RequiredStrength : "");
                ...
                case "itemSlot18":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.PlayerInventory.Count >= 18 && Player.Instance.PlayerInventory[17] != null ? "Level: " + Player.Instance.PlayerInventory[17].Lvl + " / Benoetigte Kraft: " + Player.Instance.PlayerInventory[17].RequiredStrength : "");
                    ...
                    if (Player.Instance.Strength >= currentSelectedItem.RequiredStrength)
                    {
                        switch (currentSelectedItem.Class)
                        {
                            case ItemClass.Einfaches_Gewehr:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Einfaches_Gewehr.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Normales_Gewehr:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Normales_Gewehr.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Schweres_Gewehr:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Schweres_Gewehr.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Hammer:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Hammer.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Schwert:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Schwert.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Stock:
                                ...
                                platform.updateButtonPicture("equipped_weapon", ItemClass.Stock.ToString());
                                platform.updateItemLevel("equipped_weapon", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Einfaches_Shirt:
                                ...
                                platform.updateButtonPicture("equipped_armor", ItemClass.Einfaches_Shirt.ToString());
                                platform.updateItemLevel("equipped_armor", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Einfache_Ruestung:
                                ...
                                platform.updateButtonPicture("equipped_armor", ItemClass.Einfache_Ruestung.ToString());
                                platform.updateItemLevel("equipped_armor", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Schwere_Ruestung:
                                ...
                                platform.updateButtonPicture("equipped_armor", ItemClass.Schwere_Ruestung.ToString());
                                platform.updateItemLevel("equipped_armor", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Beinkleid:
                                ...
                                platform.updateButtonPicture("equipped_boots", ItemClass.Beinkleid.ToString());
                                platform.updateItemLevel("equipped_boots", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Einfache_Kappe:
                                ...
                                platform.updateButtonPicture("equipped_helmet", ItemClass.Einfache_Kappe.ToString());
                                platform.updateItemLevel("equipped_helmet", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Hut_aus_Schrott:
                                ...
                                platform.updateButtonPicture("equipped_helmet", ItemClass.Hut_aus_Schrott.ToString());
                                platform.updateItemLevel("equipped_helmet", currentSelectedItem.Lvl);
                                break;
                            case ItemClass.Schwerer_Helm:
                                ...
                                platform.updateButtonPicture("equipped_helmet", ItemClass.Schwerer_Helm.ToString());
                                platform.updateItemLevel("equipped_helmet", currentSelectedItem.Lvl);
                                break;
                        }
                ...
                case "equipped_helmet":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.CurrentEquippedHelmet != null ? "Level: " + Player.Instance.CurrentEquippedHelmet.Lvl + " / Benoetigte Kraft: " + Player.Instance.CurrentEquippedHelmet.RequiredStrength : "");
                ...
                case "equipped_armor":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.CurrentEquippedArmor != null ? "Level: " + Player.Instance.CurrentEquippedArmor.Lvl + " / Benoetigte Kraft: " + Player.Instance.CurrentEquippedArmor.RequiredStrength : "");
                ...
                case "equipped_boots":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.CurrentEquippedBoots != null ? "Level: " + Player.Instance.CurrentEquippedBoots.Lvl + " / Benoetigte Kraft: " + Player.Instance.CurrentEquippedBoots.RequiredStrength : "");
                ...
                case "equipped_weapon":
                    ...
                    platform.updateLabel("item_lvl_strength", Player.Instance.CurrentEquippedWeapon != null ? "Level: " + Player.Instance.CurrentEquippedWeapon.Lvl + " / Benoetigte Kraft: " + Player.Instance.CurrentEquippedWeapon.RequiredStrength : "");
        ...
        public void update()
        {
            ...
            for (int i = 0; i < Player.Instance.PlayerInventory.Count; i++)
            {
                ...
                {
                    case ItemClass.Beinkleid:
                        platform.updateButtonPicture("itemSlot" + (i + 1), Player.Instance.PlayerInventory[i].Class.ToString());
                        platform.updateItemLevel("itemSlot" + (i + 1), (Player.Instance.PlayerInventory[i].Lvl));
                        break;
                    case ItemClass.Einfache_Kappe:
                        platform.updateButtonPicture("itemSlot" + (i + 1), Player.Instance.PlayerInventory[i].Class.ToString());
                        platform.updateItemLevel("itemSlot" + (i + 1), (Player.Instance.PlayerInventory[i].Lvl));
